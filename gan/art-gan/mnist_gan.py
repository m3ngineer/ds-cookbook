...
def get_training_state(generator_net, gan_type_name, epoch):
    training_state = {
        "epoch": epoch,
...
torch.save(get_training_state(generator_net, GANType.VANILLA.name, epoch+1), os.path.join(BINARIES_PATH, get_available_binary_name()))
